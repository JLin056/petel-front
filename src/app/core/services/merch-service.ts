...
import { MERCH015Tranrs } from '../interfaces/MERCH015Res.interface';
import { MERCH025Tranrs } from '../interfaces/MERCH025Res.interface';
...
export class MerchService {
     ...
     */
    queryPostal() {
        return this.http.get<MERCH015Tranrs[]>(
            'http://localhost:8080/merchants/cities/list',
            { headers: this.header }
        );
    }
     ...
     */
    queryAllFacilities() {
        return this.http.get<MERCH025Tranrs[]>(
            'http://localhost:8080/merchants/facilities/list',
            { headers: this.header }
        );
    }
}
